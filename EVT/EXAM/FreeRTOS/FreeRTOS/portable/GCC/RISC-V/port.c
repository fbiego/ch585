...
{
    SetVTFIRQ((uint32_t)SW_Handler, SWI_IRQn, 0, ENABLE);                   /* ÌáÉýÈÎÎñÇÐ»»ËÙ¶È£¬²»´ÓÍ³Ò»Èë¿ÚÖ´ÐÐ£¬ÔÚ´¦ÀíÆÚ¼ä²»¿ÉÖÐ¶ÏÇ¶Ì× */
    SetVTFIRQ((uint32_t)SysTick_Handler, SysTick_IRQn, 1, ENABLE);          /* ÌáÉýsystickÖÐ¶ÏËÙ¶È£¬²»´ÓÍ³Ò»Èë¿ÚÖ´ÐÐ£¬ÔÚ´¦ÀíÆÚ¼ä²»¿ÉÖÐ¶ÏÇ¶Ì× */
