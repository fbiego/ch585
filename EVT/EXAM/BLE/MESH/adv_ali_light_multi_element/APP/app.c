...
// The root model of the first element
...
// The root model of the second element
...
void send_support_attr(void)
{
    ...
    // First element reporting status
    ...
    // Second element reporting status
