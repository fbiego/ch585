...
/************************KEY_FIFO_DEFINE******************************/
#define KEY_COUNT       	43               // Number of keys
...
#define TKY_MEMHEAP_SIZE    	(TKY_MAX_QUEUE_NUM*TKY_BUFLEN*2)     // Externally define the data buffer length
#else
#define TKY_MEMHEAP_SIZE   		(TKY_MAX_QUEUE_NUM*TKY_BUFLEN)     	 // Externally define the data buffer length
#endif
